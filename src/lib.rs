    ...
    pub fn get_embed_languages() -> FileContent {
        FileContent::from_vec(vec![
            ...
            (
                ...
                vec![
                    "о", "е", "а", "т", "и", "н", "р", "с", "в", "л", "д", "п", "м", "к", "у",
                    "_п", "и_", "а_", "то", "е_", "_в", "ер", "ле", "ет", "г", "ы", "я", "т_", "б",
                    "_н", "о_", "на", "ь", "од", "з", "_с", "ч", "ст", "ол", "ов", "ве", "ра",
                    "по", "_и", "ни", "ен", "х", "ро", "ко", "ан", "_о", "_д", "со", "й", "_по",
                    "_на", "в_", "_м", "_к", "та", "я_", "пр", "м_", "го", "вер", "ь_", "оле",
                    "не", "лет", "ет_", "ар", "e", "ю", "ть", "те", "ор", "олет", "на_", "н_",
                    "й_", "ем", "ви", "ат", "n", "рс", "от", "марс", "мар", "ма", "ит", "ес",
                    "арс", "_пр", "_мар", "_ма", "ть_", "ре", "ел", "_на_", "у_", "ог", "об", "но",
                    "ла", "ж", "до", "_ве", "э", "щ", "ш", "хо", "толе", "тол", "ск", "ртол",
                    "рто", "рт", "ри", "ос", "ми", "ис", "ие", "ерто", "ерт", "ед", "де", "д_",
                    "го_", "верт", "a", "_з", "_вер", "_в_", "_б", "ю_", "ы_", "ход", "ус", "ом",
                    "ля", "ани", "_э", "_со", "_ис", "_и_", "_г", "эт", "че", "тор", "тв", "пл",
                    "пер", "пе", "он", "ов_", "ны", "ние", "ка", "ил", "ие_", "же", "ест", "ем_",
                    "дн", "да", "ва", "ав", "i", "_эт", "х_", "ут", "та_", "сохо", "сох", "с_",
                    "рсох", "рсо", "про", "при", "оч", "оход", "охо", "ох", "ом_", "ой", "од_",
                    "ну", "ми_", "ля_", "лет_", "ин", "из", "за", "ени", "ен_", "ди", "бо", "ате",
                    "арсо", "ам", "s", "r", "_при", "_ко", "_за", "_до", "_го", "ще", "уд", "ту",
                    "тр", "т_п", "ств", "ско", "се", "ру", "ров", "пол", "под", "ото", "ое",
                    "ого_", "ого", "овер", "ове", "о_п", "ние_", "ме", "ль", "ло", "ли_", "ли",
                    "лен", "лан", "к_", "и_н", "жен", "ду", "гр", "во", "ад", "er", "_т", "_с_",
                    "_р", "_про", "_пол", "_пер", "_пе", "_не", "_е", "0_", "ят", "это", "чн",
                    "чи", "ц", "ф", "у_п", "ту_", "тел", "ся_", "ся", "сто", "сл", "пу", "поле",
                    "план", "пла", "оро", "ой_", "мо", "лю", "ку", "кр", "ия", "им", "иа", "и_п",
                    "и_о", "и_на", "ек", "дл", "год", "вы", "бу", "ал", "а_к", "_это", "_у",
                    "_под", "_пл", "_бу", "_а", "_1", "ю_п", "ых_", "ых", "ыта", "ыт", "ши", "чес",
                    "ход_", "ую_", "ую", "ти", "тани", "тан", "т_по", "сть", "спыт", "спы", "сп",
                    "сов", "си", "ры", "ров_", "пыта", "пыт", "пы", "пос", "пере", "ост", "он_",
                    "ои", "ое_", "оди", "ода", "огр", "нс", "ное_", "ное", "нн", "лета", "кото",
                    "кот", "ки", "ия_", "ить_", "ить", "исто", "ист", "испы", "исп", "ик", "ий_",
                    "ий", "зе", "ету_", "ету", "ета_", "ета", "еск", "ере", "ение", "ее", "е_п",
                    "е_и", "для_", "для", "дит", "дет_", "дет", "дв", "да_", "гра", "ван", "в_п",
                    "буд", "бра", "бр", "ател", "ас", "ание", "ане", "аз", "ави", "а_ма", "а_м",
                    "а_и", "y_", "y", "uity", "uit", "ui", "u", "ty_", "ty", "t", "rs", "nuit",
                    "nui", "nu", "ngen", "nge", "ng", "ity_", "ity", "it", "inge",
                ],
            ),
            (
...
mod test {
    ...
    fn test_list_of_samples() {
        ...
        let textcat = Lingo::get_embed_languages();
